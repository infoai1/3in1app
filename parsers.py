    ...
    if uploaded_file.type == "application/pdf":
        ...
        for page in doc:
            ...
            for block in blocks:
                ...
                if (font_size > 14 or is_bold or is_centered or len(block_text.split()) < 20 or re.match(r"Chapter|Section", block_text)):
        ...
        for para in doc.paragraphs:
            ...
            if para.style.name.startswith("Heading") or (is_bold and font_size > 14) or len(para.text.split()) < 20:
